...
SVG_PATH = ROOT / "assets" / "visual" / "0xda-market" / "compact-emblem.svg"
DEFAULT_OUTPUT = ROOT / "build" / "visual" / "0xda-market-compact-emblem-1024.png"
EXPECTED_VIEWBOX = (0.0, 0.0, 64.0, 64.0)
EXPECTED_FILL = "#93C482"
EXPECTED_POINTS = ((32.0, 7.0), (52.0, 18.0), (52.0, 42.0), (32.0, 55.0), (12.0, 42.0), (12.0, 18.0))
EXPECTED_CHANNELS = ((32.0, 7.0, 32.0, 31.0), (12.0, 42.0, 32.0, 31.0), (52.0, 42.0, 32.0, 31.0))
EXPECTED_PNG_SHA256 = "7761193cf5360dac36738aa68a8ddbc902838a8369d9acc766babdf2680aca7f"
CANVAS = "#FFFFFF"
OUTPUT_SIZE = 1024
STROKE_WIDTH = 3.2
